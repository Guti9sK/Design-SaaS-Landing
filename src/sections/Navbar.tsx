    ...
    return (
        <>
            <section className="py-4 lg:py-8 fixed w-full top-0 z-50">
                <div className="p-container max-w-5xl mx-auto">
                    <div className="border border-white/15 rounded-[27px] md:rounded-full bg-neutral-950/70 backdrop-blur">
                        ...
                        <AnimatePresence>
                            {isOpen && (
                                ...
                                >
                                    <div className="grid grid-cols-2 items-center transition gap-6 px-4 py-6">
                                        {navLinks.map((link) => (
                                            <a
                                                key={link.label}
                                                href={link.href}
                                                onClick={(e) => handleScroll(e, link.href)}
                                                className="text-sm text-white/60 hover:text-white transition duration-300 text-center"
                                            >
                                                {link.label}
                                            </a>
                                        ))}
