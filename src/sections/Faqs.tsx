                ...
                <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map(({ question, answer }, i) => (
                        ...
                        >
                            ...
                            >
                                <h3 className="font-medium pointer-events-none">{question}</h3>
                                <svg
                            ...
                            <AnimatePresence>
                                {selectedIndex === i && (
                                    ...
                                    exit={{ height: 0, marginTop: 0 }} className={twMerge("overflow-hidden")}>
                                        <p className="text-white/50 pointer-events-none">
                                            {answer}
                                        </p>
                                    </motion.div>
                                )}
