...
import IntegrationsColumns from "@/components/IntegrationsColumns";
                ...
                <div className="grid lg:grid-cols-2 items-center lg:gap-16">
                    <div>
                        ...
                        <p className="text-white/50 mt-4 text-lg">
                            Layers seamlessly integrates with your favorite
                    ...
                    <div>
                        <div className="h-[400px] lg:h-[800px] overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)] mt-8 lg:mt-0 grid md:grid-cols-2 gap-4">
                            <IntegrationsColumns integrations={integrations} />
                            <IntegrationsColumns
